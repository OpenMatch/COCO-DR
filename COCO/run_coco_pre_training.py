...
def main():
    ...
    logger.info("Training Path: %s", data_args.train_path)
    ...
    dev_set = None
    logger.info("Finish Loading Training Set!")
    
    print(model_args.config_name, model_args.model_name_or_path)
    if model_args.config_name:
        config = AutoConfig.from_pretrained(model_args.config_name, cache_dir=model_args.cache_dir)
    elif model_args.model_name_or_path:
        logger.info("Loading COnfig! %s", model_args.model_name_or_path)
